...
1.  **Middleware Pattern**: We implemented a `HookEngine` class acting as middleware. This engine intercepts every tool execution *before* and *after* the core logic runs.
